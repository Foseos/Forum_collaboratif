...
updates = {
    ...
    'cole-turner': [
        ...
        card('Prudence Johanna Halliwell Everhart - Belle-fille', PJ,
        ...
        card('Parker Halliwell Everhart - Belle-fille', PARKER,
        ...
        card('Peyton Halliwell Everhart - Belle-fille', PEYTON,
        ...
        card('Coop Everhart - Père de mes belles-filles', COOP,
    ...
    'coop-everhart': [
        ...
        card('Prudence Johanna Halliwell Everhart - Fille aînée', PJ,
        ...
        card('Parker Halliwell Everhart - Fille', PARKER,
        ...
        card('Peyton Halliwell Everhart - Fille cadette', PEYTON,
